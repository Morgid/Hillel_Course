...
class PagePracticeForm:
    ...
    def __init__(self, driver: WebDriver):
        ...
        self.button_loc = (By.XPATH, "state")
        self.button_locator = (By.XPATH, '//*[@id="main"]/div/div[4]/div/div/div/div/div/a')
    ...
    def button_orange(self):
        return button_or(self.driver, self.button_locator)