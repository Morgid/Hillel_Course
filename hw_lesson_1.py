...
leg_a = float(input('Введіть докжину катета А: '))
...
pencil_x = int(input('Введіть кількість олівців (не більше 109): '))
pen_y = int(input('Введіть кількість ручок (не більше 109): '))
marker_z = int(input('Введіть кількість фломастерів (не більше 109): '))
pencil_coast = 3
pen_coast = 5
marker_coast = 12
