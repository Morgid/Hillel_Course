...
class CheckboxPage:
    ...
    def expand_folder(self, name) -> None:
        ...
        try:
            expand = versatile_checkbox_button.find_element(By.XPATH, "//*[@class='rct-icon rct-icon-expand-open']")
    ...
    def collapse_folder(self, name) -> None:
        ...
        try:
            expand = versatile_checkbox_button.find_element(By.XPATH, "//*[@class='rct-icon rct-icon-expand-close']")
            if expand.is_displayed():
                expand.click()
        except NoSuchElementException:
            pass
